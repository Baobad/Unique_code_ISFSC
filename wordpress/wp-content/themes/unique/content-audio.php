<article <?php hybrid_post_attributes(); ?>>
	...
	<?php if ( is_singular( get_post_type() ) ) { ?>
		...
		<header class="entry-header">
			...
			<?php echo apply_atomic_shortcode( 'entry_byline', '<div class="entry-byline">' . __( '[post-format-link] file published on [entry-published] [entry-comments-link before=" | "] [entry-edit-link before="| "]', 'unique' ) . '</div>' ); ?>
		</header><!-- .entry-header -->
